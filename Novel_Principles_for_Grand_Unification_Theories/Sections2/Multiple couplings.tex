...
\end{equation}
As in previous CAF analyses, the equations couple in such a way that we can start by only considering the gauge coupling, then the Yukawa knowing the solution for the gauge, and finally for the quartic couplings. 
...
We consider the case of $m=1,2$ corresponding to two quartic couplings. In this case, the algebraic Eq. \eqref{eq:CAF2quartic} can be written as two coupled quadratic equations
\begin{equation}
...
We consider the Yukawa coupling off fixed flow. This implies that the Yukawa coupling vanishes faster than the rest of the couplings i.e.\ ${\alpha_y}\sim\frac{1}{t^a}$, with $a>1$. Effectively, we can replace $\tilde\alpha_{y\infty}=0$. Thus, the coefficients $d,\,e,\,i\,j$ of the coupled polynomial equations (see Eqs. \eqref{eq:CAF2poly1} and \eqref{eq:CAF2poly2}) looses their dependence on $\tilde\alpha_{y\infty}$.
