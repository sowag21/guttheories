...
\end{equation}
where $\gamma^\mu$ is the gamma matrices. \comment{I use the chiral rep / weyl rep} Rewriting the equation using the momentum operator $\slashed{p}=\gamma^\mu(i\partial_\mu)$ and the $2\times 2$ form of the gamma matrices
\begin{equation}
\left[ 
\begin{pmatrix}
0 & p^0 \\
